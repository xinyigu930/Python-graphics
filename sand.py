...
This program uses 2-dimensional lists to simulate the effect of dropping sands
in a 2D sand world. The world consists of sand and rock, and only sand is affected
by gravity and can do brownian motion.
"""
...
def do_whole_grid(grid, brownian):
    ...
    >>> grid = [['s', 's', None], [None, None, None], [None, None, None]]
    >>> do_whole_grid(grid, 0)
    [[None, None, None], ['s', 's', None], [None, None, None]]
    """
    rows = len(grid)
    cols = len(grid[0])
